...
# LightGBM_MAE, LightGBM_MSE, XGBoost
...
print("lgb MSE score: {:<8.8f}".format(mean_absolute_error(oof_lgb1, y_train)))
print("lgb MSE CV score: {:<8.8f}".format(1/(mean_absolute_error(oof_lgb1, y_train)+1)))
